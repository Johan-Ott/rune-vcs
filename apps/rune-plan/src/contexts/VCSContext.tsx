// VCS Context - Manages Rune VCS state and operations
// Integrates with real Rune VCS API and provides fallback to mock data
...
// VCS State - Updated for Rune VCS
export interface VCSState {
  ...
  commits: Commit[];
  branches: Branch[];
  changelists: MockChangelist[]; // Keep for now, can be removed later
...
// Action types - Updated for Rune VCS
type VCSAction =
  ...
  | { type: 'UPDATE_FILE'; payload: { path: string; updates: Partial<File> } }
  ...
  | { type: 'SET_AI_FEATURES'; payload: Partial<VCSState['aiFeatures']> };

// Initial state - Updated for Rune VCS
